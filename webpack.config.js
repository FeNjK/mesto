...
module.exports = {
  ...
  module: {
    rules: [ // rules — это массив правил
      // добавили в него объект правил для бабеля
      {
  ...
  plugins: [
    ...
    new CleanWebpackPlugin(), // использовали плагин для очистки директории dist
    new MiniCssExtractPlugin() // подключили плагина для объединения файлов
  ]
};